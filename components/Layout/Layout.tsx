  ...
  return (
    <div className='flex w-full min-h-screen'>
      <SidebarContext.Provider value={{ isOpen, setIsOpen }}>
        <motion.aside
          className={`fixed w-[75px] top-0 h-screen py-10 px-5 shadow-inner flex flex-col z-20`}
          style={{
            background:
      ...
      <main className='ml-[75px] flex flex-col w-11/12 min-h-screen gap-8 p-8 pt-0'>
        {headerContent}
