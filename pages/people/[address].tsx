    ...
    <div>
      ...
      <div className='py-10 px-24'>
        <div className='flex gap-8'>
          <Link href='#' passHref>
            <a className='text-xl font-bold'>Activity</a>
          </Link>
          <Link href='#' passHref>
            <a className='text-xl'>Badges</a>
          </Link>
          <Link href='#' passHref>
            <a className='text-xl'>Referrals</a>
          </Link>
          <Link href='#' passHref>
            <a className='text-xl'>Blog posts</a>
          </Link>
          <Link href='#' passHref>
            <a className='text-xl'>DAOs</a>
          </Link>
        </div>

        <h3 className='mt-12 text-lg font-bold'>Recent activity</h3>
        ...
        <div className='flex gap-12 w-full'>
          <div className='w-1/2'>
            <h3 className='mt-12 text-lg font-bold'>Recent badges</h3>
          ...
          <div className='w-1/2'>
            <h3 className='mt-12 text-lg font-bold'>Recent POAPs</h3>
            <div className='flex mt-4 gap-8'>
